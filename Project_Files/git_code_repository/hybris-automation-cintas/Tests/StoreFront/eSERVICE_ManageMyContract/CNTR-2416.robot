...
*** Test Cases ***
CNTR-2416A1
    [Documentation]  CNTR-2416A Add New Deep Clean Service  (No Approver,Contract Editor)
    [Tags]    RELEASE1.2   SPRINT6    CONTRACT  BATCH2
...
CNTR-2416A2
    [Documentation]  CNTR-2416A Add New Deep Clean Service  (Approver Exists,Contract Editor)
    [Tags]    RELEASE1.2   SPRINT6    CONTRACT  BATCH2
    [Setup]    Common_Keywords.Prepare Data From XLS    ${INPUT_FILES}${CONTRACT_PATH}    CONTRACT_TEMPLATE1    ${TEST NAME}
    [Template]    eSRVC_ManageMyContract_Template.Manage My Contract Template
    ${testData}
