...
*** Test Cases ***
CNTR-2342A
    [Documentation]  SHOOP Choose from PLP within Garments (Contract Editor)
...
CNTR-2342B
    [Documentation]  SHOOP Choose from PLP within Facility Services (Contract Editor)
    [Tags]    RELEASE1.3    SPRINT6    SHOOP  BATCH1
    [Setup]    Common_Keywords.Prepare Data From XLS    ${INPUT_FILES}${SHOOP_PATH}    SHOOP_TEMPLATE1    ${TEST NAME}
    [Template]    eSRVC_ShopOutSide_Template.Shop Out Program Template
    ${testData}
...
CNTR-2342C
    [Documentation]  SHOOP Choose from PLP within Garments & Facility Services (All other Roles)
    [Tags]    RELEASE1.3    SPRINT6    SHOOP  BATCH1
    [Setup]    Common_Keywords.Prepare Data From XLS    ${INPUT_FILES}${SHOOP_PATH}    SHOOP_TEMPLATE1    ${TEST NAME}
    [Template]    eSRVC_ShopOutSide_Template.Shop Out Program Template
    ${testData}
