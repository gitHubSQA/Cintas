...
*** Test Cases ***
CNTR-2346A
    [Documentation]  SHOOP Review Request Garments Only (Contract Editor)
...
CNTR-2346B
    [Documentation]  SHOOP Review Request Facility Services Only (Contract Editor)
    [Tags]    RELEASE1.3    SHOOP    SPRINT7  BATCH1
    [Setup]    Common_Keywords.Prepare Data From XLS    ${INPUT_FILES}${SHOOP_PATH}    SHOOP_TEMPLATE1    ${TEST NAME}
    [Template]    eSRVC_ShopOutSide_Template.Shop Out Program Template
    ${testData}
...
CNTR-2346C
    [Documentation]  SHOOP Review Request Garments & Facility Services (Contract Editor)
    [Tags]    RELEASE1.3    SHOOP    SPRINT7  BATCH1
    [Setup]    Common_Keywords.Prepare Data From XLS    ${INPUT_FILES}${SHOOP_PATH}    SHOOP_TEMPLATE1    ${TEST NAME}
    [Template]    eSRVC_ShopOutSide_Template.Shop Out Program Template
    ${testData}
