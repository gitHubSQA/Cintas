...
#    UserManagement_Features.Search Wearer or Facility   ${search_text}
...
#    Run Keyword If    '${data_type}' == 'TEXT'    UserManagement_Validations.Validate Wearer or Facility Text Search Result  ${column_name}   ${search_text}
#    Run Keyword If    '${data_type}' == 'NUMBER'    UserManagement_Validations.Validate Wearer or Facility Number Search Result   ${column_name}   ${search_text}
#
