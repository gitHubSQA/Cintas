...
Service Request Template
    ...
    eSRVC_ServiceRequest_Template.Set Template Test Data    ${tc_data}
    # Call User Request Impex If '${impx_ur_update}' == 'True'
    eSRVC_ServiceRequest_Template.Call User Request Impex    ${impx_ur_update}    ${in_customer_email}    ${impx_ur_account_type}
    # Call Service Request Impex If '${impx_sr_update}' == 'True'
    eSRVC_ServiceRequest_Template.Call Service Request Impex    ${impx_sr_update}    ${testcase_name}    ${impx_sr_requester}    ${impx_sr_soldto}    ${impx_sr_category}   ${impx_category_code}   ${impx_sr_creation_time}
    ...    ${impx_sr_review_time}    ${impx_sr_pending_status_count}    ${impx_sr_rejected_status_count}
    # Begin Test
    eSRVC_ServiceRequest_Template.Begin Test
    # Login to Front End
    eSRVC_ServiceRequest_Template.Login to Front End    ${in_customer_email}    ${in_customer_password}
    # Validate Top Menu Approver Option
    eSRVC_ServiceRequest_Template.Validate Top Menu Approver Option    ${vp_sr_top_menu_approver}    ${impx_ur_account_type}

    # Go to Service Requests
    eSRVC_ServiceRequest_Template.Go to Service Requests
    # Validate Available Buttons based on '${impx_ur_account_type}'
    eSRVC_ServiceRequest_Template.Validate Available Buttons By Account Type    ${impx_ur_account_type}
    # Select MY or OTHER Service requests
    eSRVC_ServiceRequest_Template.Select Requests To View    ${wf_requests_to_view}
    # Validate create service request mandatory fields
    eSRVC_ServiceRequest_Template.Validate create service request mandatory fields    ${vp_sr_mandatory_field}    ${in_subject}    ${in_details}
    # Validate headers if '${wf_headers}' == 'True'
    eSRVC_ServiceRequest_Template.Validate headers    ${vp_headers1}    ${wf_requests_to_view}

    # Validate Default fields if '${wf_default_value}' == 'True'
    eSRVC_ServiceRequest_Template.Validate Default fields    ${vp_default_value}    ${wf_requests_to_view}
    # Validate Search Error Messages if '${vp_search_errors}' == 'True'
    eSRVC_ServiceRequest_Template.Validate Search Error Messages    ${vp_search_errors}
    # Validate the number of Service Requests Returned if '${wf_request_count}' == 'True'
    eSRVC_ServiceRequest_Template.Validate the number of Service Requests Returned    ${vp_request_count}    ${vp_min_request_count_exp}
    # Validate Default Order of Service Requests (Pending Old first - Rejected New first) if '${vp_default_srlist}' == 'True'
    eSRVC_ServiceRequest_Template.Validate Default Order of Service Requests    ${vp_default_srlist}
    # Filter Service Requests if '${wf_filter}' == 'True'
    eSRVC_ServiceRequest_Template.Filter Service Requests    ${wf_filter}    ${vp_filter_start_date}    ${vp_filter_end_date}    ${vp_filter_status}    ${vp_filter_text}
    # Validate headers2 if '${wf_headers2}' == 'True'
    eSRVC_ServiceRequest_Template.Validate headers2    ${vp_headers2}
    # Validate Filter if    '${vp_filter}' == 'True'
    eSRVC_ServiceRequest_Template.Validate Filter    ${vp_filter}    ${vp_filter_sort_type}    ${vp_sort_criteria}    ${vp_filter_start_date}    ${vp_filter_end_date}    ${vp_filter_status}
    ...    ${vp_filter_text}
    # Validate Sort if '${vp_sort}' == 'True'
    eSRVC_ServiceRequest_Template.Validate Sort    ${vp_sort}    ${vp_sort_criteria}
    # Select Service Request If '${wf_select_sr}' == 'True'
    eSRVC_ServiceRequest_Template.Select Service Request    ${wf_select_sr}
    # Validate Elements of SR Details If '${vp_srdtl_elements}' == 'True'
    eSRVC_ServiceRequest_Template.Validate Elements of SR Details    ${vp_srdtl_elements}    ${wf_requests_to_view}
    # Validate Values of SR Details If '${vp_srdtl_values}' == 'True'
    eSRVC_ServiceRequest_Template.Validate Values of SR Details    ${vp_srdtl_values}
    # Select Response for SR ApproveReject If '${wf_sr_response}' == 'True'
    eSRVC_ServiceRequest_Template.Select Response for SR ApproveReject    ${wf_sr_reply}    ${in_sr_message}    ${in_sr_response}
    # Validate SR Reject Message IF '${vp_sr_error}' == 'True'
    eSRVC_ServiceRequest_Template.Validate SR Reject Message    ${vp_sr_error}
    # Select Confirmation Message action APPROVE/CANCEL or REJECT/CANCEL iF '${wf_sr_resp_confim}' == 'True'
    eSRVC_ServiceRequest_Template.Select Confirmation Message action    ${wf_sr_resp_confim}    ${in_sr_resp_confim}
    ...
    eSRVC_ServiceRequest_Template.Validate SR Response Message    ${vp_sr_resp_msg}    ${in_sr_resp_confim}
    # Delete SR
    eSRVC_ServiceRequest_Template.Call Delete Service Request Impex    ${impx_sr_update}    ${impx_sr_requester}    @{sr_list}
    Comment    Impex_Keywords.Import Impex Delete Service Request    ${impx_sr_requester}    @{sr_list}
...
Call Service Request Impex
    [Arguments]    ${impx_sr_update}    ${testcase_name}    ${impx_sr_requester}    ${impx_sr_soldto}    ${impx_sr_category}  ${impx_category_code}   ${impx_sr_creation_time}
    ...    ${impx_sr_review_time}    ${impx_sr_pending_status_count}    ${impx_sr_rejected_status_count}
    @{sr_list} =    Run Keyword If    '${impx_sr_update}' == 'TRUE' or '${impx_sr_update}' == '1'    Impex_Keywords.Import Impex Service Request With Category and Review Date    ${testcase_name}    ${impx_sr_requester}    ${impx_sr_soldto}
    ...    ${impx_sr_category}    ${impx_category_code}  ${impx_sr_creation_time}    ${impx_sr_review_time}    ${impx_sr_pending_status_count}    ${impx_sr_rejected_status_count}
    set test variable    @{sr_list}

Validate Top Menu Approver Option
    [Arguments]    ${vp_sr_top_menu_approver}    ${impx_ur_account_type}
    Run Keyword If    '${vp_sr_top_menu_approver}' == 'TRUE' or '${vp_sr_top_menu_approver}' == '1'    ServiceRequest_Validations.Validate Top Menu Approval Option    ${impx_ur_account_type}
...
Validate create service request mandatory fields
    ...
    Run Keyword If    '${vp_sr_mandatory_field}' == 'TRUE' or '${vp_sr_mandatory_field}' == '1'    ServiceRequest_Validations.Validate Create SR Mandatory Fields    ${in_subject}    ${in_details}

Validate headers
    [Arguments]    ${vp_headers1}    ${wf_requests_to_view}
    Run Keyword If    '${vp_headers1}' == 'TRUE' or '${vp_headers1}' == '1'    ServiceRequest_Validations.Validate Headers    ${wf_requests_to_view}

Validate Default fields
    [Arguments]    ${vp_default_value}    ${wf_requests_to_view}
    Run Keyword If    '${vp_default_value}' == 'TRUE' or '${vp_default_value}' == '1'    ServiceRequest_Validations.Validate Default Search Field values    ${wf_requests_to_view}

Validate Search Error Messages
    [Arguments]    ${vp_search_errors}
    Run Keyword If    '${vp_search_errors}' == 'TRUE' or '${vp_search_errors}' == '1'    ServiceRequest_Validations.Validate Search Error Messages

Validate the number of Service Requests Returned
    [Arguments]    ${vp_request_count}    ${vp_min_request_count_exp}
    Run Keyword If    '${vp_request_count}' == 'TRUE' or '${vp_request_count}' == '1'    ServiceRequest_Validations.Validate Request Count    ${vp_min_request_count_exp}

Validate Default Order of Service Requests
    [Arguments]    ${vp_default_srlist}
    Run Keyword If    '${vp_default_srlist}' == 'TRUE' or '${vp_default_srlist}' == '1'    ServiceRequest_Validations.Validate Default Sorting

Filter Service Requests
    [Arguments]    ${wf_filter}    ${vp_filter_start_date}    ${vp_filter_end_date}    ${vp_filter_status}    ${vp_filter_text}
    Run Keyword If    '${wf_filter}' == 'TRUE' or '${wf_filter}' == '1'    ServiceRequest_Keywords.Filter Service request    ${vp_filter_start_date}    ${vp_filter_end_date}    ${vp_filter_status}    ${vp_filter_text}

Validate headers2
    [Arguments]    ${vp_headers2}
    Run Keyword If    '${vp_headers2}' == 'TRUE' or '${vp_headers2}' == '1'    ServiceRequest_Validations.Validate Headers Others Requests Rejected

Validate Filter
    [Arguments]    ${vp_filter}    ${vp_filter_sort_type}    ${vp_sort_criteria}    ${vp_filter_start_date}    ${vp_filter_end_date}    ${vp_filter_status}
    ...    ${vp_filter_text}
    Run Keyword If    '${vp_filter}' == 'TRUE' or '${vp_filter}' == '1'    ServiceRequest_Validations.Validate Service Request Filter    ${vp_filter_sort_type}    ${vp_sort_criteria}    ${vp_filter_start_date}    ${vp_filter_end_date}
    ...    ${vp_filter_status}    ${vp_filter_text}

Validate Sort
    [Arguments]    ${vp_sort}    ${vp_sort_criteria}
    Run Keyword If    '${vp_sort}' == 'TRUE' or '${vp_sort}' == '1'    ServiceRequest_Validations.Validate Service Request Sort Asc And Dec    ${vp_sort_criteria}
##----------------------------------------------------------------------------------------
Select Service Request
    [Arguments]    ${wf_select_sr}
    Run Keyword If    '${wf_select_sr}' == 'TRUE' or '${wf_select_sr}' == '1'    ServiceRequest_Keywords.Select An Service Request    @{sr_list}[0]

##----------------------------------------------------------------------------------------------------
Validate Elements of SR Details
    [Arguments]    ${vp_srdtl_elements}    ${wf_requests_to_view}
    Run Keyword If    '${vp_srdtl_elements}' == 'TRUE' or '${vp_srdtl_elements}' == '1'    ServiceRequest_Validations.Validate SR Detail Page Elements    ${wf_requests_to_view}

Validate Values of SR Details
    [Arguments]    ${vp_srdtl_values}
    Run Keyword If    '${vp_srdtl_values}' == 'TRUE' or '${vp_srdtl_values}' == '1'    ServiceRequest_Validations.Validate SR Detail Values    DEM306    HYB306
...
Validate SR Reject Message
    ...
    Run Keyword If    '${vp_sr_error}' == 'TRUE' or '${vp_sr_error}' == '1'    ServiceRequest_Validations.Validate SR Reject Error Message

Select Confirmation Message action
    [Arguments]    ${wf_sr_resp_confim}    ${in_sr_resp_confim}
    Run Keyword If    '${wf_sr_resp_confim}' == 'TRUE' or '${wf_sr_resp_confim}' == '1'    ServiceRequest_Keywords.Service Request Reply Confirmation    ${in_sr_resp_confim}

Validate SR Response Message
    [Arguments]    ${vp_sr_resp_msg}    ${in_sr_resp_confim}
    Run Keyword If    '${vp_sr_resp_msg}' == 'TRUE' or '${vp_sr_resp_msg}' == '1'    ServiceRequest_Validations.Validate Approval of Pending SR    ${in_sr_resp_confim}

Call Delete Service Request Impex
    [Arguments]    ${impx_sr_update}    ${impx_sr_requester}    @{sr_list}
    Run Keyword If    '${impx_sr_update}' == 'TRUE' or '${impx_sr_update}' == '1'    Impex_Keywords.Import Impex Delete Service Request    ${impx_sr_requester}    @{sr_list}
#-----------------------------------------------------------------------------------------------------------------
#--------------------------------- Template Test Data ------------------------------------------------------------
#-----------------------------------------------------------------------------------------------------------------
Set Template Test Data
    ...
    # Review Time
    ${impx_sr_review_time}=    Pop From Dictionary    ${tc_data}    impx_sr_review_time    default=${EMPTY}
    Set Test Variable    ${impx_sr_review_time}
    # SR Category
    ${impx_sr_category}=    Pop From Dictionary    ${tc_data}    impx_sr_category    default=${EMPTY}
    Set Test Variable    ${impx_sr_category}
    # SR Category Code
    ${impx_category_code}=    Pop From Dictionary    ${tc_data}    impx_category_code    default=${EMPTY}
    Set Test Variable    ${impx_category_code}
    # SR Status
