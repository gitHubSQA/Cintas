...
Set Template Test Data
    ...
    #---Comment for Add/Update/Remove uniform/product
    #${comment2500char}=  FakerLibrary.Text    2500
    # 255 Character
#    ${comment255char}=  FakerLibrary.Text    100
#    set test variable   ${comment255char}
    #${comment255char}=  set variable  Start255 Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata End255.
